...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        Distribution.__init__(self, avg, std)
    ...
    def replace_stats_with_data(self):
        ...
        self.p = sum([i for i in self.data if i == 1])  / len(self.data)
    ...
    def pdf(self, k):
        ...
        ncr = math.factorial(self.n) / (math.factorial(k) * math.factorial(self.n - k))
        pdf = ncr * (self.p ** k) * ((1 - self.p) ** (self.n - k))
        return pdf
